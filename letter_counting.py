...
def _parse_args():
    ...
    parser.add_argument('--num_positions', type=int, default = 20, help= "Number of positions that need to be ecnoded")
    ...
    parser.add_argument('--causalMask', type=bool, default=False, help="causla mask for attention")  
...
if __name__ == '__main__':
    ...
    # just to see dependence on num_layers, att_heads...
    # Constructs and labels the data
    train_exs = read_examples(args.train) # list of strings(len=10000) with len(each_strings)=20
